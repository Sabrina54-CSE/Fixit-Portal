...
<body>
  ...
  <section class="hero-section">
    ...
    <div class="hero-content">
      ...
      <p>Fixit Portal is your trusted platform to report and resolve campus and hall-related issues efficiently.
         Whether it's an administrative concern, maintenance problem or any other campus-related issue,
          we're here to ensure swift action. With real-time notifications and direct communication tools,
           we make it easier for you to get things done. Join us and help improve the campus community for everyone.</p>
    </div>
  </section>
  <footer>
